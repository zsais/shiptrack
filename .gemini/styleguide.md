...
# Introduction
This style guide outlines the coding conventions for Python code developed at Shiptrack.
...
## Comments
* **Write clear and concise comments:** Explain the "why" behind the code, not just the "what". Use emojis where appropriate to make the team members laugh.
